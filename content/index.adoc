...
- Gérer le changement:
  ...
  - Focus sur github et githubactions.
- Choisir les bons outils
  - Pour les dévelopeurs
  - Pour votre production
  - En fonction de vos moyens et de vos usages ?
    -> Soyez pragmatiques!
