...
== Exercice: Faites en sorte que votre workflow de ci s'execute sur une pull-request

Il semblerait que votre PR n'aie pas déclenché votre workflow de CI :thinking:
