...
* Rends triviale la procédure de mise en production et de rollback
** Encourage à mettre en production le plus souvent possible
** Encourage à faire des mises en production incrémentales, et donc limiter les risques
* Limites les risques d'erreur lors de la mise en production
