...
** 💡 `mvn -v`
** 💡 https://github.com/marketplace/actions/setup-java-jdk[window="_blank"]
** 💡 https://github.com/marketplace/actions/setup-maven[window="_blank"]
...
[source,yaml]
----
include::../code-samples/gh-actions/menu-server.yml[tags="!pr"]
----
