...
* Super on à un test, il ne reste plus qu'à le lancer avec `mvn run` 🎉
...
* Super on à un test (qui teste!), il ne reste plus qu'à le lancer avec `mvn run` 🎉
* Spoiler:
...
* Démarer et provisionner un environement d'execution (une DB, Elasticsearch, un autre service...)
* Démarer votre application
* Jouer un scenario de test
* Eteindre et nettoyer son environement d'execution pour garantir l'isolation des tests
...
* Les tests d'integration soient lancé
