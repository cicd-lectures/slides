...
* Avec le mode verbeux d'activé par défaut
...
**  Prouve que GET /vehicles retourne la liste des vehicles les plus proche d'un point donné
...
Optionnel mais, si les tests d'intégration échouent à ce point, il serait bon de corriger votre implémentation de la suppression de vehicule.
